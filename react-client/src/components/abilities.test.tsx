...
const mockAbilities = [
  { name: 'ability 1', effect: 'some effect', flavour_text: 'this ability does things'},
  { name: 'ability 2', effect: 'some other effect', flavour_text: 'this ability does other things'},
];
...
describe('abilities', () => {
  ...
  test('ability flavour texts render', () => {
    ...
    expect(screen.getByText('this ability does other things')).toBeInTheDocument();
  });
});